...
nrDataRoot="../data_src"
name='learnable_blur_k9_b1_livingroom_dilated_uniform_7816_nearest4_deltaView_drop0.5_patch_raypoints_residuals_frameWeight1'
...
dilation_setup='7_8_1_6'
dilation_mode='uniform'

add_blur_sim=1
blur_kernel_version=2  # 1: asymmetrical, 2: symmetrical, 3: both
blur_kernel_size=9
num_move_dirs=8
move_dists='1,2,4'
