...
nrDataRoot="../data_src"
name='scene241_dilated_uniform_7818_blur_nearest4_deltaView_drop0.5_patch_raypoints_residuals_frameWeight1'
...
ray_points=1
drop_patch=1  # 1: drop all rays' img feats in random patches; 0: randomly drop rays' img feats
